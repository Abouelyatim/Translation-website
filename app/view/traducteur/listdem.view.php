    ...
    foreach ($demande as $dem) {
        ...
        <tr>
            ...
            <td><?= $dem[6]?></td>
                ...
                <td>
                    <?php
                    if($dem[6]!='acceptadmin' && $dem[6]!='terminer' ){
                    ?>
                        <a  target="_blank" style="color: #383d41" href="/web/public/uploads/documents/<?php  echo $dem[5] ?>" >download source</a>

                    <form class="modal-content animate" action="listdem/<?= $dem[7]?>/<?= $dem[6]?>" method="post">

                        <button type="submit" name="submit1077" > accepter </button>
                        <input type="number" placeholder="Enter prix" name="prix" required>

                    </form>
                    <button style="width: 50% " type="submit" name="submit10" value="save"><a style="color: #c3e6cb" href="/web/public/traducteur/refuser/<?=$dem[7]?>" onclick="">resfuser</a></button>
                        <?php
                    }
                    ?>
                    <?php
                    if($dem[6]=='acceptadmin'){
                        ?>
                        <button><a style="color: #c3e6cb" href="/web/public/traducteur/terminer/<?=$dem[7]?>" onclick="">terminer</a></button>
...
<div style="display: inline-flex;width: 100%" >
    <button   style="width:10%;margin-left: 15px;margin-right: 15px ;"><a style="color: #f7f5fe" href= "/web/public/traducteur/login"  >retour</a></button>
</div>