...
<button type="submit" name="submit101"  style="width:10%;margin-left: 15px;margin-right: 15px ;">filtrer selon</button>
    <select name="tree1" style="width:15%; height:auto;">
        ...
        <option value="clinsupr">cilent non suprimer</option>
        <option value="clisupr">cilent suprimer</option>
...
<table class="data" id="myTable2">
    ...
    <tr>
        ...
        <th>mail</th>
        <th>block</th>
        <th onclick="sortTable(5)">nb demmande</th>
        <th>suprimer</th>
        <th>control</th>
