...
<div  id="socialContainer">
   <h2 id="titel1">list traducteur</h2>
...
<div id="navbar">
    <form class="modal-content animate" action="" method="post" style="background:#4d5256 ">
        ...
        <select name="tree4" style="width:15%; height:auto;">
            ...
            <option value="tradnsupr">traducteur non suprimer</option>
            <option value="tradsupr">traducteur suprimer</option>
...
<table class="data" id="myTable2">
    ...
    <tr>
        ...
        <th onclick="sortTable(10)">nb doc</th>
        <th>suprimer</th>
        <th>control</th>
