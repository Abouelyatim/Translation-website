...
<div  id="socialContainer">
    <h2 id="titel1">liste des documents</h2>
</div>

<div id="navbar">
<form class="modal-content animate" action="" method="post"style="background:#4d5256">
    ...
    <select name="tree99" style="width:15%; height:auto;">
        ...
        <option value="docacctrad">document accepter traducteur</option>
        <option value="docacccli">document accepter client</option>
        <option value="docaccadmi">document accepter admin</option>
        ...
        <tr>
            ...
            if($ctrl=='profilclient'){
                ...
                <td>
                    ...
                    <a target="_blank" style="color: #1b1e21" href="/web/public/uploads/images/<?php  echo $dem[12] ?>" >download bon</a>
                    ...
                    <a style="color: #21bfbf" href="/web/public/admin/accepterdocument/<?=$dem[7]?>/<?= $dem[6]?>" onclick="">accepter</a>
                </td>
            <?php } ?>
